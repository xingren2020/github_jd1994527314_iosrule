...
hd_nm=['ID@上车','NC@农场','NS@年兽','MC@萌宠','JC@惊喜工厂','DC@京东工厂','ZD@种豆']
hd_me=['ME@注册圈友']
...
tback=['1.京东互助码提交机器人测试中，请在对话框输入字符 /  查看对应指令再发送内容。每个京东活动互助码分开提交,格式:活动简称大写字母+互助码,多个互助码用@连接,例如京东农场NC12333@885666@8556\n',]
#=====================================
def help_update():
   help=''
   try:
